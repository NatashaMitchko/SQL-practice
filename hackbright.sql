...
--
-- Name: projects_if_seq; Type: SEQUENCE; Schema: public; Owner: user
--

CREATE SEQUENCE projects_if_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE projects_if_seq OWNER TO "user";

--
-- Name: projects_if_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--

ALTER SEQUENCE projects_if_seq OWNED BY projects.id;
...
ALTER TABLE ONLY projects ALTER COLUMN id SET DEFAULT nextval('projects_if_seq'::regclass);
...
COPY grades (id, project_title, grade, student_github) FROM stdin;
1	Markov	10	jhacks
2	Markov	50	sdevelops
3	Blockly	100	sdevelops
5	Blockly	2	jhacks
\.
...
3	Blockly2	Better Programmatic Logic Puzzle Game	100
4	SAT	Standardized Test About Nothing Important	1600
5	Monopoly	The Great Depression	25
6	Oregon Trail	The Great Depression	48
7	Clue	Find the killer	72
\.


--
-- Name: projects_if_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--

SELECT pg_catalog.setval('projects_if_seq', 7, true);
